...
function Side() {
  return (
    <div className='flex items-center justify-center'>
      <div
  class="duration-300 font-mono text-white group cursor-pointer relative overflow-hidden bg-[#f3f6fb] w-28 h-48 dark:bg-[#05090d61] rounded-3xl p-4 hover:w-56 hover:bg-blue-200 hover:dark:bg-[#0C66E4]"
>
